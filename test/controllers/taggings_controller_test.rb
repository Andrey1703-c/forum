...
class TaggingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tagging" do
    assert_difference("Tagging.count") do
      post taggings_url, params: { tagging: { tag_id: @tagging.tag_id, thread_id: @tagging.thread_id } }
    end
  ...
  test "should update tagging" do
    patch tagging_url(@tagging), params: { tagging: { tag_id: @tagging.tag_id, thread_id: @tagging.thread_id } }
