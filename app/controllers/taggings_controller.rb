class TaggingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tagging.save
        format.html { redirect_to tagging_url(@tagging), notice: "Tagging was successfully created." }
  ...
  def update
    respond_to do |format|
      if @tagging.update(tagging_params)
        format.html { redirect_to tagging_url(@tagging), notice: "Tagging was successfully updated." }
  ...
  private
    ...
    def tagging_params
      params.require(:tagging).permit(:tag_id, :thread_id)
    end
end
